...
export default function Home() {
  const [activeView, setActiveView] = useState<"rag" | "knowledge" | "logs" | "settings">("rag")

  const viewConfig: Record<
    "rag" | "knowledge" | "logs" | "settings",
    ...
    <>
      ...
      <aside className="w-72 shrink-0 border-r border-gray-800 bg-gray-800 flex flex-col">
        ...
        <div className="flex items-center gap-3 px-6 py-5 border-b border-gray-800">
          ...
          <div>
            <p className="text-sm font-semibold tracking-tight text-purple-500">
              Kiker Shop
            </p>
        ...
        <nav className="flex-1 px-3 py-4 space-y-2 text-sm">
          <p className="px-2 text-[11px] uppercase tracking-wide text-gray-400">
            Navegação
          </p>
          <SidebarItem
            icon={BrainCircuit}
          ...
          <div className="space-y-2 text-xs">
            <div className="flex items-center justify-between rounded-lg bg-gray-900 px-3 py-2">
              <span className="truncate mr-4">
                Tênis para corrida acima de R$ 300
              </span>
              <span>12</span>
            ...
            <div className="flex items-center justify-between rounded-lg bg-gray-900 px-3 py-2">
              <span className="truncate mr-4">
                Tênis casual masculino conforto
              </span>
              <span>9</span>
